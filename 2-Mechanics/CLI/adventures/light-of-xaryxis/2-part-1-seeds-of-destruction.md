...
![Captain Elaina Sartell](2-Mechanics/CLI/adventures/light-of-xaryxis/img/006-09-002-captain-elaina-sartell.webp#center)
...
Captain's Quarters. Among Captain Sartell's possessions is a locked treasure chest, which she keeps in her cabin. Captain Sartell carries the only key to the chest. As an action, a character can pick the lock by making a successful DC 15 Dexterity check using thieves' tools, or break open the chest with a successful DC 15 Strength ([Athletics](skills.md#Athletics)) check. The chest contains three bottles of fine wine (10 gp each), six gold bracelets (25 gp each), nine pearls (100 gp each) in a velvet pouch, and a [spell scroll](spell-scroll-xdmg.md) of air bubble (see the "Astral Adventurer's Guide").
...
A character who examines the captain's chair and succeeds on a DC 15 Intelligence ([Investigation](skills.md#Investigation)) check finds a secret compartment in the left armrest. This compartment contains a black metal tube containing a [spell scroll](spell-scroll-xdmg.md) of [wall of force](wall-of-force-xphb.md).
...
Lying on the deck near the dead mind flayer is an [Ioun stone (reserve)](ioun-stone-reserve-xdmg.md). The stone currently holds a single casting of the [shield](2-Mechanics/CLI/spells/shield-xphb.md) spell.
